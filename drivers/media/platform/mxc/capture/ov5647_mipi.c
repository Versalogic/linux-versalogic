...
static DEVICE_ATTR(ov5647_reg, 0664, show_reg, set_reg);
static DEVICE_ATTR(ov5647_mode, 0664, show_mode, set_mode);
			...
			const struct i2c_device_id *id)
{
	...
	ov5647_data.pix.pixelformat = V4L2_PIX_FMT_GREY; /*V4L2_PIX_FMT_SBGGR8;*/
